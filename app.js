...
import {
  ...
  viewPublicProfile, loadVipUsersList, showVipConfetti, loadVipRequestSettingsPage,
  blockUserByAdmin
} from './dashboard.js';
...
export function navigateTo(page) {
  ...
  switch (page) {
    ...
    case 'vip-request-settings': loadVipRequestSettingsPage(); break;
    default: break;
  }
